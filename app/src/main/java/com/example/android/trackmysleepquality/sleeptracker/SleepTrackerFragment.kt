...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModel = ViewModelProviders.of(this, viewModelFactory)[SleepTrackerViewModel::class.java]
        ...
        viewModel.nights.observe(viewLifecycleOwner, Observer { sleepNights ->
            sleepNights?.let {
                adapter.data = it
            }
        })
        ...
        viewModel.showSnackBarEvent.observe(viewLifecycleOwner, Observer { isDataCleared ->
